...
BRICK_START_X = -452
BRICK_START_Y = 290
BRICK_COLORS = ["#FF00FF", "#00FFFF", "#FFFF00", "#FF8C00", "#FF1493", "#00FF00", "#FF4500", "#1E90FF"]
BRICK_Y_OFFSET = -26
...
class Bricks:
    ...
    def create_single_brick(self, x, y, color):
        ...
        border.color("black")
        border.shape("square")
        border.shapesize(stretch_wid=1.1, stretch_len=5.4)
        border.penup()
        border.goto(x, y)
        border.stamp()
    ...
    def create_bricks(self):
        for row in range(BRICK_ROWS):
            y = BRICK_START_Y - row * (BRICK_HEIGHT + BRICK_Y_OFFSET)
